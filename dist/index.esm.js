...
var Connector = styled.div(templateObject_1$p || (templateObject_1$p = __makeTemplateObject(["\n  position: absolute;\n  width: 4px;\n  height: 100%;\n  top: 50%;\n  left: calc(50% - 2px);\n  z-index: -1;\n  background-color: ", ";\n"], ["\n  position: absolute;\n  width: 4px;\n  height: 100%;\n  top: 50%;\n  left: calc(50% - 2px);\n  z-index: -1;\n  background-color: ", ";\n"])), function (_a) {
    var theme = _a.theme, status = _a.status;
    return theme.colors[status === "past" ? "success" : "textDisabled"];
});
var ChildrenWrapper = styled(Box)(templateObject_2$b || (templateObject_2$b = __makeTemplateObject(["\n  ", " {\n    visibility: ", ";\n  }\n"], ["\n  ", " {\n    visibility: ", ";\n  }\n"])), function (_a) {
    var theme = _a.theme;
    return theme.mediaQueries.md;
}, function (_a) {
...
var ChildrenLeftWrapper = styled(ChildrenWrapper)(templateObject_3$7 || (templateObject_3$7 = __makeTemplateObject(["\n  display: none;\n  ", " {\n    display: block;\n    margin-right: 16px;\n  }\n"], ["\n  display: none;\n  ", " {\n    display: block;\n    margin-right: 16px;\n  }\n"])), function (_a) {
    var theme = _a.theme;
    return theme.mediaQueries.md;
});
...
var float = keyframes(templateObject_1$k || (templateObject_1$k = __makeTemplateObject(["\n\t0% {\n\t\ttransform: translatey(0px);\n\t}\n\t50% {\n\t\ttransform: translatey(10px);\n\t}\n\t100% {\n\t\ttransform: translatey(0px);\n\t}\n"], ["\n\t0% {\n\t\ttransform: translatey(0px);\n\t}\n\t50% {\n\t\ttransform: translatey(10px);\n\t}\n\t100% {\n\t\ttransform: translatey(0px);\n\t}\n"])));
var Container$3 = styled.div(templateObject_2$9 || (templateObject_2$9 = __makeTemplateObject(["\n  position: relative;\n"], ["\n  position: relative;\n"])));
var FloatingOgeeIcon = styled(Icon$v)(templateObject_3$6 || (templateObject_3$6 = __makeTemplateObject(["\n  position: absolute;\n  top: 30px;\n  left: 23px;\n  animation: ", " 3s ease-in-out infinite;\n  transform: translate3d(0, 0, 0);\n"], ["\n  position: absolute;\n  top: 30px;\n  left: 23px;\n  animation: ", " 3s ease-in-out infinite;\n  transform: translate3d(0, 0, 0);\n"])), float);
...
var Icon$k = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 128 128" }, props),
        React.createElement("path", { d: "M128,64a62.87,62.87,0,0,1-6.7,28.4h0A63.87,63.87,0,0,1,64,128h0A63.87,63.87,0,0,1,6.7,92.4h0A62.87,62.87,0,0,1,0,64,64,64,0,0,1,64,0h0A64,64,0,0,1,128,64Z", fill: "#3269f7" }),
        React.createElement("path", { d: "M73.9,45.2C73.9,31,67,18.9,61.8,14.8c0,0-.3-.2-.3.3-.4,27.4-14.3,34.8-21.9,44.7-17.7,23-1.2,48.4,15.4,52.9,9.3,2.6-2.3-4.6-3.7-19.8C49.8,74.4,73.9,60.4,73.9,45.2", fill: "#fff" }),
        React.createElement("path", { d: "M83.2,54.5h-.3c-.3,3.4-4.1,10.8-8.7,17.5-16,22.9-6.9,33.9-1.7,39.9,3,3.5,0,0,7.5-3.5.6-.3,14.5-7.6,16-24.4,1.1-16.4-9.2-26.6-12.8-29.5", fill: "#fff" })));
};
...
var Logo = function (_a) {
    ...
    return (React.createElement(Flex, null,
        ...
        isAbsoluteUrl ? (React.createElement(StyledLink, { as: "a", href: href, "aria-label": "Ogeefinance home page" }, innerLogo)) : (React.createElement(StyledLink, { to: href, "aria-label": "Ogeefinance home page" }, innerLogo))));
};
...
var OytPrice = function (_a) {
    ...
    return oytPriceUsd ? (React.createElement(PriceLink, { href: "https://info.ogeeswap.com/token/0x38F950511a2479206aC640818f1F7bd093277E02", target: "_blank" },
        React.createElement(Icon$S, { width: "20px", mr: "4px" }),
        React.createElement(Text, { color: "textSubtle", bold: true }, "$" + oytPriceUsd.toFixed(3)))) : (React.createElement(Skeleton, { width: 80, height: 24 }));
};
var OytPrice$1 = React.memo(OytPrice);
...
var PanelFooter = function (_a) {
    ...
    return (React.createElement(Container, null,
        React.createElement(SocialEntry, null,
            React.createElement(OytPrice$1, { oytPriceUsd: oytPriceUsd }),
...
var ConnectModal = function (_a) {
    ...
    return (React.createElement(Modal, { title: "Connect to a wallet", onDismiss: onDismiss },
        ...
        React.createElement(HelpLink, { href: "https://docs.hecochain.com/#/wallet", external: true },
...
var NetworkLinks = function () { return (React.createElement(Flex, null, networks.map(function (network, index) {
    ...
    if (network.items) {
        return (React.createElement(MenuButton, { scale: "sm", variant: "tertiary", marginRight: "8px" },
            React.createElement(Dropdown, { key: network.label, position: "bottom", target: React.createElement(Icon, __assign({}, iconProps, { mr: mr })) }, network.items.map(function (item) { return (React.createElement(Link, { external: true, key: item.label, href: item.href, "aria-label": item.label, color: "primary" }, item.label)); }))));
    }
    return (React.createElement(Link, { external: true, key: network.label, "aria-label": network.label, mr: mr, color: "primary" },
        React.createElement(Icon, __assign({}, iconProps)),
        " ",
        network.label));
}))); };
var NetworkLinks$1 = React.memo(NetworkLinks, function () { return true; });
    ...
    return (React.createElement(Wrapper, null,
        React.createElement(StyledNav, { showMenu: showMenu },
            ...
            React.createElement(Flex, null,
                React.createElement(NetworkLinks$1, null),
                React.createElement(UserBlock$1, { account: account, login: login, logout: logout }),
                profile && React.createElement(Avatar, { profile: profile }))),
        React.createElement(BodyWrapper, null,
            React.createElement(Panel, { isPushed: isPushed, isMobile: isMobile, showMenu: showMenu, isDark: isDark, toggleTheme: toggleTheme, langs: langs, setLang: setLang, currentLang: currentLang, oytPriceUsd: oytPriceUsd, pushNav: setIsPushed, links: links }),
...
export { Icon$1x as AddIcon, Alert, Icon$1w as ArrowBackIcon, Icon$1v as ArrowDownIcon, Icon$1u as ArrowDropDownIcon, Icon$1t as ArrowDropUpIcon, Icon$1s as ArrowForwardIcon, Icon$1r as ArrowUpIcon, Icon$1q as AutoRenewIcon, BackgroundImage, GridLayout$1 as BaseLayout, Icon$1z as BlockIcon, Box, Breadcrumbs, Icon$1o as BunnyPlaceholderIcon, Button, ButtonMenu, ButtonMenuItem, Icon$1l as CalculateIcon, Card, CardBody, CardFooter, CardHeader, CardRibbon, Icon$1m as CardViewIcon, Icon$1n as Cards, GridLayout as CardsLayout, Icon$1j as ChartIcon, Checkbox, Icon$1B as CheckmarkCircleIcon, Icon$1i as CheckmarkIcon, Icon$1h as ChevronDownIcon, Icon$1g as ChevronLeftIcon, Icon$1f as ChevronRightIcon, Icon$1e as ChevronUpIcon, Icon$1k as CircleOutlineIcon, Icon$1d as CloseIcon, Icon$1c as CogIcon, Icon$1b as CommunityIcon, ConnectorNames, Icon$1a as CopyIcon, Icon$19 as CrownIcon, Dropdown, Icon$1A as ErrorIcon, FallingBunnies, Icon$18 as FeeIcon, Flex, Heading, Icon$17 as HelpIcon, Icon$16 as HistoryIcon, Icon$1p as HuobiIcon, IconButton, Image, Icon$1y as InfoIcon, Input$1 as Input, Icon$15 as LaurelLeftIcon, Icon$14 as LaurelRightIcon, Link, LinkExternal, Icon$13 as ListViewIcon, Icon$12 as LogoIcon, Icon$11 as LogoRoundIcon, Icon$10 as MedalBronzeIcon, Icon$$ as MedalGoldIcon, Icon$_ as MedalPurpleIcon, Icon$Z as MedalSilverIcon, Icon$Y as MedalTealIcon, Menu, Icon$X as MetamaskIcon, Icon$W as MinusIcon, Modal, ModalProvider, Icon$V as NoProfileAvatarIcon, NotificationDot, Icon$S as OgeefinanceRoundIcon, Icon$T as OgeefinancesIcon, Icon$U as OpenNewIcon, Icon$Q as PlayCircleOutlineIcon, Icon$R as PocketWatchIcon, Icon$P as PrizeIcon, Progress, Icon$M as ProgressBunny, Radio, Icon$w as RefreshIcon, Icon$O as RemoveIcon, ResetCSS, Icon$C as SearchIcon, Skeleton, Spinner, Step, Stepper, Svg, Icon$B as SwapVertIcon, Icon$A as SyncAltIcon, Tag, Icon$J as TeamPlayerIcon, Icon$I as TestnetIcon, Text, Icon$H as Ticket, Icon$G as TicketRound, Icon$F as TimerIcon, ToastContainer, Toggle, Icon$E as TrophyGoldIcon, Icon$D as TuneIcon, Icon$N as VerifiedIcon, Icon$z as VolumeOffIcon, Icon$y as VolumeUpIcon, Icon$L as WaitIcon, Icon$x as WarningIcon, Icon$K as Won, variants$2 as alertVariants, byTextAscending, byTextDescending, connectorLocalStorageKey, darkTheme as dark, darkColors, lightTheme as light, lightColors, makeRender, links as menuConfig, types as toastTypes, useKonamiCheatCode, useMatchBreakpoints, useModal, useParticleBurst, useTable, useWalletModal };
