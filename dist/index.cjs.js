...
var Connector = styled__default['default'].div(templateObject_1$r || (templateObject_1$r = __makeTemplateObject(["\n  position: absolute;\n  width: 4px;\n  height: 100%;\n  top: 50%;\n  left: calc(50% - 2px);\n  z-index: -1;\n  background-color: ", ";\n"], ["\n  position: absolute;\n  width: 4px;\n  height: 100%;\n  top: 50%;\n  left: calc(50% - 2px);\n  z-index: -1;\n  background-color: ", ";\n"])), function (_a) {
    var theme = _a.theme, status = _a.status;
    return theme.colors[status === "past" ? "success" : "textDisabled"];
});
var ChildrenWrapper = styled__default['default'](Box)(templateObject_2$7 || (templateObject_2$7 = __makeTemplateObject(["\n  ", " {\n    visibility: ", ";\n  }\n"], ["\n  ", " {\n    visibility: ", ";\n  }\n"])), function (_a) {
    var theme = _a.theme;
    return theme.mediaQueries.md;
}, function (_a) {
...
var ChildrenLeftWrapper = styled__default['default'](ChildrenWrapper)(templateObject_3$2 || (templateObject_3$2 = __makeTemplateObject(["\n  display: none;\n  ", " {\n    display: block;\n    margin-right: 16px;\n  }\n"], ["\n  display: none;\n  ", " {\n    display: block;\n    margin-right: 16px;\n  }\n"])), function (_a) {
    var theme = _a.theme;
    return theme.mediaQueries.md;
});
var ChildrenRightWrapper = styled__default['default'](ChildrenWrapper)(templateObject_4$1 || (templateObject_4$1 = __makeTemplateObject(["\n  margin-left: 8px;\n  ", " {\n    margin-left: 16px;\n  }\n"], ["\n  margin-left: 8px;\n  ", " {\n    margin-left: 16px;\n  }\n"])), function (_a) {
    var theme = _a.theme;
    return theme.mediaQueries.md;
});
var Wrapper$1 = styled__default['default'].div(templateObject_5 || (templateObject_5 = __makeTemplateObject(["\n  position: relative;\n  display: flex;\n  align-items: center;\n"], ["\n  position: relative;\n  display: flex;\n  align-items: center;\n"])));
...
var templateObject_1$r, templateObject_2$7, templateObject_3$2, templateObject_4$1, templateObject_5, templateObject_6;
...
var templateObject_1$u, templateObject_2$8;
...
var FloatingOgeeIcon = styled__default['default'](Icon$15)(templateObject_3$3 || (templateObject_3$3 = __makeTemplateObject(["\n  position: absolute;\n  top: 30px;\n  left: 23px;\n  animation: ", " 3s ease-in-out infinite;\n  transform: translate3d(0, 0, 0);\n"], ["\n  position: absolute;\n  top: 30px;\n  left: 23px;\n  animation: ", " 3s ease-in-out infinite;\n  transform: translate3d(0, 0, 0);\n"])), float);
...
var templateObject_1$w, templateObject_2$9, templateObject_3$3;
...
var templateObject_1$x, templateObject_2$a, templateObject_3$4, templateObject_4$2, templateObject_5$1;
...
var templateObject_1$y, templateObject_2$b, templateObject_3$5;
...
var IconModule = /*#__PURE__*/Object.freeze({
    ...
    FarmIcon: Icon$16,
    GroupsIcon: Icon$17,
    HamburgerIcon: Icon$18,
    HamburgerCloseIcon: Icon$19,
    HomeIcon: Icon$1a,
    IfoIcon: Icon$1b,
    InfoIcon: Icon$1c,
    GithubIcon: Icon$1d,
    LanguageIcon: Icon$1e,
...
var Logo$1 = function (_a) {
    ...
    var innerLogo = (React__default['default'].createElement(React__default['default'].Fragment, null,
        React__default['default'].createElement(Icon$y, { className: "mobile-icon" }),
        React__default['default'].createElement(LogoWithText, { className: "desktop-icon", isDark: isDark })));
    return (React__default['default'].createElement(Flex, null,
        React__default['default'].createElement(MenuButton, { "aria-label": "Toggle menu", onClick: togglePush, mr: "12px" }, isPushed ? (React__default['default'].createElement(Icon$19, { width: "24px", color: "textSubtle" })) : (React__default['default'].createElement(Icon$18, { width: "24px", color: "textSubtle" }))),
...
var OytPrice = function (_a) {
    var oytPriceUsd = _a.oytPriceUsd;
    return oytPriceUsd ? (React__default['default'].createElement(PriceLink, { href: "https://info.ogeeswap.com/token/0xf7e522999cA7F1306D4df1B5eFcCFAB6A1eD99d6", target: "_blank" },
        React__default['default'].createElement(Icon$K, { width: "20px", mr: "4px" }),
        React__default['default'].createElement(Text, { color: "textSubtle", bold: true }, "$" + oytPriceUsd.toFixed(3)))) : (React__default['default'].createElement(Skeleton, { width: 80, height: 24 }));
};
var OytPrice$1 = React__default['default'].memo(OytPrice);
...
var SocialLinks = function () { return (React__default['default'].createElement(Flex, null, socials.map(function (social, index) {
    ...
    var mr = index < socials.length - 1 ? "2px" : 0;
    if (social.items) {
...
var PanelFooter = function (_a) {
    var isPushed = _a.isPushed, pushNav = _a.pushNav, toggleTheme = _a.toggleTheme, isDark = _a.isDark, oytPriceUsd = _a.oytPriceUsd, currentLang = _a.currentLang, langs = _a.langs, setLang = _a.setLang;
    if (!isPushed) {
    ...
    return (React__default['default'].createElement(Container$4, null,
        React__default['default'].createElement(SocialEntry, null,
            React__default['default'].createElement(OytPrice$1, { oytPriceUsd: oytPriceUsd }),
...
var StyledAvatar = styled__default['default'].div(templateObject_1$M || (templateObject_1$M = __makeTemplateObject(["\n  margin-left: 8px;\n  position: relative;\n\n  img {\n    border-radius: 50%;\n  }\n"], ["\n  margin-left: 8px;\n  position: relative;\n\n  img {\n    border-radius: 50%;\n  }\n"])));
...
var Menu = function (_a) {
    var _b;
    var account = _a.account, login = _a.login, logout = _a.logout, isDark = _a.isDark, toggleTheme = _a.toggleTheme, langs = _a.langs, setLang = _a.setLang, currentLang = _a.currentLang, oytPriceUsd = _a.oytPriceUsd, links = _a.links, profile = _a.profile, children = _a.children;
    ...
    return (React__default['default'].createElement(Wrapper$2, null,
        ...
        React__default['default'].createElement(BodyWrapper, null,
            React__default['default'].createElement(Panel, { isPushed: isPushed, isMobile: isMobile, showMenu: showMenu, isDark: isDark, toggleTheme: toggleTheme, langs: langs, setLang: setLang, currentLang: currentLang, oytPriceUsd: oytPriceUsd, pushNav: setIsPushed, links: links }),
...
var templateObject_1$N, templateObject_2$i, templateObject_3$9, templateObject_4$3, templateObject_5$2;
...
var lightColors = __assign(__assign(__assign({}, baseColors), brandColors), { background: "radial-gradient(50% 50% at 50% 50%, rgba(89, 89, 244, 0.15) 0%, rgba(255, 255, 255, 0) 100%)", backgroundDisabled: "#E5EAEF", contrast: "#16181D", invertedContrast: "#F7F7FD", input: "#F1F1FB", inputSecondary: "#CACAF1", tertiary: "#EEEEF5", text: "#262636", textDisabled: "#BDC2C4", textSubtle: "#646490", borderColor: "#E9EAEB", card: "rgba(255, 255, 255, 0.9)", gradients: {
        bubblegum: "linear-gradient(139.73deg, #F6F6FF 0%,#DDDDFF 100%)",
    } });
var darkColors = __assign(__assign(__assign({}, baseColors), brandColors), { secondary: "#7878FF", background: "radial-gradient(50% 50% at 50% 50%, rgba(24, 25, 34, 0.95) 0%, rgba(24, 25, 34, 1) 100%)", backgroundDisabled: "#454756", contrast: "#FEFEFF", invertedContrast: "#1F212B", input: "#303240", inputSecondary: "#505096", primaryDark: "#6565F1", tertiary: "#2C2F3B", text: "#F2F2FF", textDisabled: "#606271", textSubtle: "#9797CC", borderColor: "#33373C", card: "rgba(31, 34, 44, 0.9)", gradients: {
...
exports.HuobieIcon = Icon$c;
exports.IconButton = IconButton;
exports.Image = Image;
exports.InfoIcon = Icon$3;
exports.Input = Input;
exports.LaurelLeftIcon = Icon$v;
...
exports.MedalBronzeIcon = Icon$A;
exports.MedalGoldIcon = Icon$B;
exports.MedalPurpleIcon = Icon$C;
exports.MedalSilverIcon = Icon$D;
...
exports.Svg = Svg;
exports.SwapVertIcon = Icon$$;
exports.SyncAltIcon = Icon$10;
exports.Tag = Tag;
...
exports.VolumeOffIcon = Icon$11;
exports.VolumeUpIcon = Icon$12;
