...
var templateObject_1$I, templateObject_2$g, templateObject_3$7, templateObject_4$2;
...
var float = styled.keyframes(templateObject_1$k || (templateObject_1$k = __makeTemplateObject(["\n\t0% {\n\t\ttransform: translatey(0px);\n\t}\n\t50% {\n\t\ttransform: translatey(10px);\n\t}\n\t100% {\n\t\ttransform: translatey(0px);\n\t}\n"], ["\n\t0% {\n\t\ttransform: translatey(0px);\n\t}\n\t50% {\n\t\ttransform: translatey(10px);\n\t}\n\t100% {\n\t\ttransform: translatey(0px);\n\t}\n"])));
var Container$3 = styled__default['default'].div(templateObject_2$9 || (templateObject_2$9 = __makeTemplateObject(["\n  position: relative;\n"], ["\n  position: relative;\n"])));
var FloatingOgeeIcon = styled__default['default'](Icon$o)(templateObject_3$6 || (templateObject_3$6 = __makeTemplateObject(["\n  position: absolute;\n  top: 30px;\n  left: 23px;\n  animation: ", " 3s ease-in-out infinite;\n  transform: translate3d(0, 0, 0);\n"], ["\n  position: absolute;\n  top: 30px;\n  left: 23px;\n  animation: ", " 3s ease-in-out infinite;\n  transform: translate3d(0, 0, 0);\n"])), float);
...
var Logo = function (_a) {
    ...
    return (React__default['default'].createElement(Flex, null,
        React__default['default'].createElement(MenuButton, { "aria-label": "Toggle menu", onClick: togglePush, mr: "12px" }, isPushed ? (React__default['default'].createElement(Icon$k, { width: "24px", color: "textSubtle" })) : (React__default['default'].createElement(Icon$l, { width: "24px", color: "textSubtle" }))),
        isAbsoluteUrl ? (React__default['default'].createElement(StyledLink, { as: "a", href: href, "aria-label": "Ogeefinance home page" }, innerLogo)) : (React__default['default'].createElement(StyledLink, { to: href, "aria-label": "Ogeefinance home page" }, innerLogo))));
};
...
var lightColors = __assign(__assign(__assign({}, baseColors), brandColors), { background: "#F9F9FF", backgroundDisabled: "#E5EAEF", contrast: "#2D3033", invertedContrast: "#FEFEFF", input: "#F1F1FB", inputSecondary: "#CACAF1", tertiary: "#EEEEF5", text: "#262636", textDisabled: "#BDC2C4", textSubtle: "#4444C6", borderColor: "#E9EAEB", card: "#FEFEFF", gradients: {
        bubblegum: "linear-gradient(139.73deg, #F6F6FF 0%,#DDDDFF 100%)",
    } });
var darkColors = __assign(__assign(__assign({}, baseColors), brandColors), { secondary: "#7878FF", background: "#181822", backgroundDisabled: "#454756", contrast: "#FEFEFF", invertedContrast: "#2D3033", input: "#303240", inputSecondary: "#505096", primaryDark: "#6565F1", tertiary: "#2C2F3B", text: "#F2F2FF", textDisabled: "#606271", textSubtle: "#8282FF", borderColor: "#33373C", card: "#232430", gradients: {
...
exports.OgeefinanceRoundIcon = Icon$D;
exports.OgeefinancesIcon = Icon$E;
